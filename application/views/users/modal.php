...
<div slot="body" class="row">
    ...
    <div slot="foot">
        ...
        <button class="btn btn-default" @click="addModal = false">close</button>
    </div>
...
<div slot="body" class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="gambar" id="gambar">
            <div class="mt-2">
                <img :src="imgUser(chooseUser.gambar)"  width='100' height="100">
            </div>
        </div>
    </div>
</div>
<div slot="foot">
    ...
    <button class="btn btn-default" @click="editModal = false">close</button>
</div>
</modal>
