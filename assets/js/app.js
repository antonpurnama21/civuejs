...
var v = new Vue({
   el:'#app',
    ...
    methods:{
        ...
        //     this.selectedFile = $('#gambar').prop('files')[0];
        //     formData.append('file', this.selectedFile);
        //     //console.log(formData);
        //     axios.post(this.url+"user/addImage", formData).then(function(response){
        ...
        imgUser(value){
            if (value == '') {
                return v.url+'assets/img/user/default.jpg'
            }else{
                return v.url+value //for image gender sign in the table
            }
        },
